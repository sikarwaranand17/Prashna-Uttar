...
$assets_location = '../';
$config_file = dirname(dirname(__FILE__)) ."/library/config.php";
$lib_path = dirname(dirname(__FILE__)) ."/library/";

if(!file_exists($config_file)) {
	$file = fopen($config_file,"w");
	if(!$file) {
		die("Error! config.php file not found .. please create an empty file at <pre>/library/config.php</pre>");
	}
}
...
require_once("'.$lib_path.'url_mapper.php");
...
<html lang="en">
  <head>
	...
	<!-- Bootstrap core CSS -->
    <link href="<?php echo $assets_location; ?>public/css/bootstrap.min.css?v=1.01" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo $assets_location; ?>public/css/custom.css?v=1.01" rel="stylesheet">

	<link href="<?php echo $assets_location; ?>public/fonts/feather/feather.css" rel="stylesheet">
	
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <link href="<?php echo $assets_location; ?>public/css/ie10-viewport-bug-workaround.css" rel="stylesheet">
...
<body>
  ...
  <a class="navbar-brand" href="<?php echo $url_mapper['index/']; ?>" style="color:#b92b27;font-size:25px">Pearls! installer</a>
  ...
  <div class="collapse navbar-collapse row" id="navbarSupportedContent">
	<ul class="navbar-nav mr-auto navbar-right col-3 d-flex justify-content-end">
			...
			<li class="nav-item active">
				<a class="nav-link " href="#me"><i class="fe fe-power"></i> Install</a>
			</li>
			<li class="nav-item ">
				<a class="nav-link " href="https://codecanyon.net/item/pearls-questions-and-answers-platform/19305873/comments" target="_blank"><i class="fe fe-send"></i> Support</a>
			</li>
...
<div class="row">
	...
	<i class="fe fe-list"></i>&nbsp;&nbsp;Server Requirements
	<hr>
	<ul class="feed-ul">
		<?php if($php_version && $php_version >= 5.5 ) { ?>
		<li style='color:green'><i class='fe fe-check'></i> PHP Version: <?php echo phpversion(); ?></li>
		<?php } else { ?>
		<li style='color:red' ><i class='fe fe-x'></i> PHP Version: <?php echo phpversion(); ?></li>
		<?php
		$errors[] = "<b>PHP Version</b> is not compatible with this script, please install PHP > 5.4 first!"; } ?>
		
		
		<?php if(!$safe_mode) { ?>
		<li style='color:green'><i class='fe fe-check'></i> Safe Mode: Disabled</li>
		<?php } else { ?>
		<li style='color:red' ><i class='fe fe-x'></i> Safe Mode: Enabled</li>
		<?php
		$errors[] = "<b>Safe Mode</b> is enabled, please disabled safe mode first!"; } ?>
		
		<?php /*if($mod_rewrite) { ?>
		<li style='color:green'><i class='fa fa-ok'></i> Mod_Rewrite: Enabled</li>
		<?php } else { ?>
		<li style='color:red' ><i class='fa fa-times'></i> Mod_Rewrite: Disabled</li>
		<?php
		$errors[] = "<b>mod_rewrite</b> module is disabled, please enable mod_rewrite first!"; }*/ ?>
		
		<?php if($privileges) { ?>
		<li style='color:green'><i class='fe fe-check'></i> Write Privileges: Granted</li>
		<?php } else { ?>
		<li style='color:red' ><i class='fe fe-x'></i> Write Privileges: Disabled</li>
		<?php
		$errors[] = "<b>Write Privileges</b> to the config file are disabled, please correct 'public/includes/config.php' permissions to (775) first!"; } ?>
	</ul>
	</div>
	...
	<div class="col-md-9">
		...
		?>
			<div class="alert alert-danger">
				<i class="fa fa-times"></i> <strong>Error!</strong>&nbsp;&nbsp;<?php echo $error; ?>
			</div>
		<?php 
			}}
		?>
		<div class= "page-header">
			<h3>Welcome to Pearls! installer script<small style="float: right">[ Step <?php echo $step; ?> of <?php echo $steps; ?> ]</small></h3>
		</div>
		...
		switch($step) {
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="db_pass" id="db_pass" value="<?php echo $db_pass; ?>" >
			</div>	
			<div class="form-group">
			  ...
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					...
					<img src="facebook_5.jpg" style="width:100%"><br><br>
					...
					echo $url2.'/login/?provider=facebook'.'<br>';
					$url2 = str_replace('www.','',$url);
					if(substr($url2, -1) == '/') {
						$url2= substr($url2, 0, -1);
					}
					echo $url2.'login/?provider=facebook';?>
					</pre><br>
					<br>
			...
			<div class="modal fade" id="google_modal" tabindex="-1" role="dialog" aria-labelledby="GoogleCaptchaInfo">
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					- First, go to <a href="https://console.developers.google.com/apis/dashboard"  target="_blank">this link</a>, and choose (Credentials) from left sidebar<br><br>
					...
					<pre><?php echo $url2 . '/login.php?provider=Google';?></pre>
					<br>
					...
					<center><a href="google_1.jpg" target="_blank"><img src="google_1.jpg" style="width:100%"></a><br><br>
					<a href="google_2.jpg" target="_blank"><img src="google_2.jpg" style="width:100%"></a><br><br>
					<a href="google_3.jpg" target="_blank"><img src="google_3.jpg" style="width:100%"></a><br><br>
					<a href="google_4.jpg" target="_blank"><img src="google_4.jpg" style="width:100%"></a><br><br>
					<a href="google_5.jpg" target="_blank"><img src="google_5.jpg" style="width:100%"></a><br><br>
					</center>
				  </div>
				  <div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	...
	<a href="http://michael-designs.com" target="_blank">Michael Designs </a>&copy; 2020
	</div>	
...
<script>window.jQuery || document.write('<script src="<?php echo $assets_location; ?>public/js/vendor/jquery.min.js"><\/script>')</script>
<script src="<?php echo $assets_location; ?>public/js/bootstrap.min.js"></script>

<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
<script src="<?php echo $assets_location; ?>public/js/ie10-viewport-bug-workaround.js"></script>
