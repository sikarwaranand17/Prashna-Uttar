...
if(filesize(LIBRARY_PATH.'config.php') == '0') { die('Please install script first!'); }


$assets_location = '../../';
$config_file = LIBRARY_PATH ."config.php";
$rand = "RandomHash!";
...
<html lang="en">
  <head>
	...
	<link href="<?php echo $assets_location; ?>public/plugins/summernote/summernote.css" rel="stylesheet">
	<link href="<?php echo $assets_location; ?>public/plugins/tagsinput/bootstrap-tagsinput.css" rel="stylesheet">
	<link href="<?php echo $assets_location; ?>public/plugins/typeahead/typeaheadjs.css?v=1.01" rel="stylesheet">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
		...
		<ul class="nav navbar-nav navbar-right">
            <li class='current'><a href="#me"><i class="fa fa-retweet"></i>&nbsp;&nbsp;Update</a></li>
            <li class=''><a href="mailto:michael.zohney@gmail.com"><i class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;Support</a></li>
          </ul>
...
<div class="row">
	...
	<i class="fa fa-tasks"></i>&nbsp;&nbsp;Server Requirements
	<hr>
	<ul class="feed-ul">
		<?php if($php_version && $php_version >= 5.4 ) { ?>
		<li style='color:green'><i class='fa fa-ok'></i> PHP Version: <?php echo phpversion(); ?></li>
		<?php } else { ?>
		<li style='color:red' ><i class='fa fa-times'></i> PHP Version: <?php echo phpversion(); ?></li>
		<?php
		$errors[] = "<b>PHP Version</b> is not compatible with this script, please install PHP > 5.4 first!"; } ?>
		
		
		<?php if(!$safe_mode) { ?>
		<li style='color:green'><i class='fa fa-ok'></i> Safe Mode: Disabled</li>
		<?php } else { ?>
		<li style='color:red' ><i class='fa fa-times'></i> Safe Mode: Enabled</li>
		<?php
		...
		<?php if($privileges) { ?>
		<li style='color:green'><i class='fa fa-ok'></i> Write Privileges: Granted</li>
		<?php } else { ?>
		<li style='color:red' ><i class='fa fa-times'></i> Write Privileges: Disabled</li>
		<?php
...
<script src="<?php echo $assets_location; ?>public/plugins/typeahead/typeahead.js"></script>
<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
