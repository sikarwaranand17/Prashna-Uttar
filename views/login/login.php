...
<html lang="en">
  ...
  <body>
	...
	?>
		<img src="<?php echo WEB_LINK."public/".$file->image_path(); ?>" style='max-height:60px;' id="site-logo" class='' />
	<?php } else {
		echo APPNAME; 
	}
  ?></center></h3><br>
					...
					<?php if(isset($_GET['logout']) && $_GET['logout'] == 'true' ) { ?>
						...
						<div class="col-md-6 horizontal-separator">
							<div id="social-login">
								...
								<?php if(!isset($settings['social']) || isset($settings['social']) && $settings['social'] == '1' ) { ?>
							...
							<div id="register-block" style='display:none'>
								<form method="POST" action="<?php echo $url_mapper['login/']; ?>" >
									...
									<div class="form-group">
										<label for="first_name" class="col-form-label"><?php echo $lang['login-register-f_name']; ?></label>
										<input type="text" class="form-control " id="first_name" name="first_name" placeholder="" value="" required>
									</div>
									</div>
									<div class="col-md-6">
									<div class="form-group">
										<label for="last_name" class="col-form-label"><?php echo $lang['login-register-l_name']; ?></label>
										<input type="text" class="form-control " id="last_name" name="last_name" placeholder="" value="" required>
									</div>
									</div>
									<div class="col-md-12">
									<div class="form-group">
										<label for="reg-email" class="col-form-label"><?php echo $lang['login-register-email']; ?></label>
									...
									<div class="col-md-12">
									<div class="form-group">
										<label for="reg-password" class="col-form-label"><?php echo $lang['login-register-pass']; ?></label>
									...
									<a href="javascript:void(0);" id="cancel-register" class="btn btn-secondary" ><?php echo $lang['btn-cancel']; ?></a>
									<?php
